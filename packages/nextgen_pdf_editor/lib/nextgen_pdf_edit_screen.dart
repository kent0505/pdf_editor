...
final List<String> stampPaths = [
  'assets/stamp/Group47.png',
  'assets/stamp/Group 48.png',
  'assets/stamp/Group 49.png',
  'assets/stamp/Group 50.png',
  'assets/stamp/Group 51.png',
  'assets/stamp/Group 52.png',
  'assets/stamp/Group 53.png',
  'assets/stamp/Group 54.png',
];

final figures = [
  'assets/figures/cirlce.png',
  'assets/figures/square.png',
  'assets/figures/triangle.png',
];
...
class _OPdfEditScreenState extends State<NGPdfEditScreen> {
  ...
  Future<void> _addImage() async {
    ...
    if (pickedFile != null) {
      ...
      setState(() {
        selectedMode = DrawingMode.image;
      });
    }
  }

  Future<void> _addStamp(String stampPath) async {
    try {
      // Загружаем изображение из assets
      final ByteData data = await rootBundle.load(stampPath);
      ...
      debugPrint('Error loading stamp: $e');
    }
  }

  Future<void> _addFigure(String figurePath) async {
    try {
      // Загружаем изображение из assets
      final ByteData data = await rootBundle.load(figurePath);
      final Uint8List bytes = data.buffer.asUint8List();
      ...
      debugPrint('Error loading figure: $e');
    }
  }
  ...
  Widget getAppBarContent() {
    ...
    switch (_selectedIndex) {
      ...
      case 10:
        return buildStamp(); // Stamp option
      case 11:
        return Row(
        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              itemCount: stampPaths.length,
              itemBuilder: (context, index) {
                return InkWell(
                  onTap: () {
                    _addStamp(stampPaths[index]);
                  },
                  child: Image.asset(stampPaths[index], width: 50, height: 50),
                );
              },
            ),
          ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: const Color(0xffF2F2F7), // Background color for the page
      appBar:
          _selectedIndex != -1
              ...
              : BottomAppBar(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    if (widget.draw) _buildBottomNavItem(Icons.draw, "Draw", 0),
                    if (widget.text)
                    ...
                    //     3,
                    //   ),
                    _buildBottomNavItem(Icons.image, "Image", 4),
                    _buildBottomNavItem(Icons.architecture, "Figure", 11),
                    _buildBottomNavItem(
    ...
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(icon, color: enabled ? Colors.black : Colors.grey[700]),
  ...
  Widget _buildActionButton({
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(color: Colors.black), // White border around button
      ),
      child: IconButton(
        icon: Icon(
          icon,
        ...
        onTap: () {
          setState(() {
            ...
            switch (index) {
              ...
              case 10:
                _changeMode(DrawingMode.stamp); // Set mode to stamp
                break;
              case 11:
                _changeMode(DrawingMode.figure); // Set mode to figure
                break;
              default:
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Icon(
                icon,
                color: Colors.black, // Change color when selected
                size: isSelected ? 26 : 20, // Change size when selected
              ),
              Text(
                label,
                style: TextStyle(
                  color: Colors.black, // Change text color when selected
                  fontSize: 10,
                  fontWeight:
                      isSelected
                          ? FontWeight.bold
...
class _DrawingCanvasState extends State<DrawingCanvas> {
    ...
    return GestureDetector(
      ...
      child: Stack(
        children: [
          ...
          ...widget.imageController.getImageBoxes().map(
            (imageBox) => _buildImageWidget(imageBox, widget.doneImage),
          ),
  ...
  Positioned _buildImageWidget(ImageBox imageBox, VoidCallback onTap) {
    return Positioned(
      ...
      child: GestureDetector(
        onPanUpdate: (details) {
          if (widget.selectedMode == DrawingMode.image ||
              widget.selectedMode == DrawingMode.stamp) {
            setState(() {
