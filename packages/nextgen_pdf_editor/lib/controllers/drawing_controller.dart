...
class DrawingController extends ChangeNotifier {
  ...
  DrawingController({required this.strokeWidth});
  ...
  void startDraw(Offset startPoint) {
    ...
    _history[_currentPage]!.add(SimpleLine(startPoint, _currentColor, strokeWidth));
    notifyListeners();
  }
...
class SimpleLine extends PaintContent {
  ...
  SimpleLine(Offset startPoint, this.color, this.strokeWidth) {
